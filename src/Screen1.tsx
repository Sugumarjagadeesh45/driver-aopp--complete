          ...
          if (response && response.success) {
            ...
            try {
              ...
              const passengerData: UserDataType = {
                ...
                name: response.userName || response.name || currentRideObj?.userName || ride?.userName || 'Passenger',
                mobile: response.userPhone || response.userMobile || response.mobile || currentRideObj?.userMobile || ride?.userMobile || '',
                location: {
                  latitude: pickupLat,
                  longitude: pickupLng,
                },
